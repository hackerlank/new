...
function OnRedeemGoldEvent_ChristmasGold(uid,goldnum)
	...
	if country == 1 then
		...
		if curGoldNum >= 5000 and s_getVar(uid,116,214) == 0 then
			s_sysMail(uid,"每日累计充值送好礼：您今日累计充值达5000金币,已额外返还1000绑银以纪念币道具的形式发送到您的包裹里了，请注意查收！（活动期间每天累计充值越多返还的越多哦！）")
		...
		if curGoldNum >= 10000 and s_getVar(uid,116,214) == 1 then
			s_sysMail(uid,"每日累计充值送好礼：您今日累计充值达10000金币,已额外返还3000绑银以纪念币道具的形式发送到您的包裹里了，请注意查收！（活动期间每天累计充值越多返还的越多哦！）")
		...
		if curGoldNum >= 50000 and s_getVar(uid,116,214) == 3 then
			s_sysMail(uid,"每日累计充值送好礼：您今日累计充值达50000金币,已额外返还21000绑银以纪念币道具的形式发送到您的包裹里了，请注意查收！（活动期间每天累计充值越多返还的越多哦！）")
		...
		if curGoldNum >= 100000 and s_getVar(uid,116,214) == 4 then
			s_sysMail(uid,"每日累计充值送好礼：您今日累计充值达100000金币,已额外返还48000绑银以纪念币道具的形式发送到您的包裹里了，请注意查收！（活动期间每天累计充值越多返还的越多哦！）")
		...
		if curGoldNum >= 200000 and s_getVar(uid,116,214) == 5 then
			s_sysMail(uid,"每日累计充值送好礼：您今日累计充值达200000金币,已额外返还108000绑银以纪念币道具的形式发送到您的包裹里了，请注意查收！（活动期间每天累计充值越多返还的越多哦！）")
