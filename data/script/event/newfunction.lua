...
--英雄礼包
function OnUseItemEvent_34187(uid,thisid)
	if s_deleteItemByThisID(uid,thisid,1,"OnUseItemEvent_34187") ~= VALUE_OK then
		return VALUE_FAIL
	end
	s_addItem(uid,24125,3,1,0,"1-1","60英雄包")
	s_addItem(uid,34188,3,1,0,"1-1","60英雄包")
	s_addItem(uid,32219,3,1,0,"1-1","60英雄包")
	s_addItem(uid,30019,3,3,0,"1-1","60英雄包")
	return VALUE_OK
end

--70级绿色宝箱
function OnUseItemEvent_34188(uid,thisid)
	if s_deleteItemByThisID(uid,thisid,1,"OnUseItemEvent_34188") ~= VALUE_OK then
		return VALUE_FAIL
	end
	s_addItem(uid,32220,3,1,0,"1-1","70英雄包")
	s_addItem(uid,34189,0,1,0,"1-1","70英雄包")
	s_addItem(uid,30019,3,3,0,"1-1","70英雄包")
	return VALUE_OK
end

--80级绿色宝箱
function OnUseItemEvent_34189(uid,thisid)
	if s_deleteItemByThisID(uid,thisid,1,"OnUseItemEvent_34189") ~= VALUE_OK then
		return VALUE_FAIL
	end
	s_addItem(uid,32221,3,1,0,"1-1","80英雄包")
	s_addItem(uid,30019,3,3,0,"1-1","80英雄包")
	return VALUE_OK
end

function OnUseItemEvent_31800(uid,thisid)
	local hours = s_getCurTime(TIME_CURHOURS)
	if hours >= 21 then
		s_sysInfo(uid,"请在每天21:00前使用该道具")
		return VALUE_FAIL
	end
	if s_deleteItemByThisID(uid,thisid,1,"OnUseItemEvent_31800") ~= VALUE_OK then
		return VALUE_FAIL
	end
	s_addItem(uid,29800,0,2,0,"1-1","OnUseItemEvent_31800")
	s_addItem(uid,29135,0,1,0,"1-1","OnUseItemEvent_31800")
	s_addItem(uid,26141,0,25,0,"1-1","OnUseItemEvent_31800")
	s_addItem(uid,6,0,20,0,"1-1","OnUseItemEvent_31800")
	s_addItem(uid,26149,0,1,0,"1-1,2-3","OnUseItemEvent_31800")
	return VALUE_OK
end

--羽翼功能开放送的礼盒
function OnUseItemEvent_31801(uid,thisid)
	local hours = s_getCurTime(TIME_CURHOURS)
	if s_deleteItemByThisID(uid,thisid,1,"OnUseItemEvent_31801") ~= VALUE_OK then
		return VALUE_FAIL
	end
	s_addItem(uid,27125,0,5,0,"1-1","OnUseItemEvent_31801")
	s_addItem(uid,27126,0,25,0,"1-1","OnUseItemEvent_31801")
	return VALUE_OK
end

--人生转轮放送的礼盒
function OnUseItemEvent_31802(uid,thisid)
	local hours = s_getCurTime(TIME_CURHOURS)
	if s_deleteItemByThisID(uid,thisid,1,"OnUseItemEvent_31802") ~= VALUE_OK then
		return VALUE_FAIL
	end
	s_addItem(uid,28000,0,40,0,"1-1","OnUseItemEvent_31802")
	return VALUE_OK
end
