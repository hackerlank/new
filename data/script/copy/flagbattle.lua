		...
		for i = 1,table.getn(list), 2 do--回收旗帜
			...
			if s_getField(list[i+1],UserVar_PowerOrder) <= 500 and
				...
				if index == 1 then
					...
					s_sysMail(list[i+1],"恭喜您获得血战到底第一名奖励：羽灵*18！",0,27125,18,"1-1")
				elseif index == 2 then
					--s_addTitle(SCENE_ENTRY_PLAYER,list[i+1],37)
					s_sysMail(list[i+1],"恭喜您获得血战到底第二名奖励：羽灵*14！请再接再厉！再升1名可获得羽灵*18！",0,27125,14,"1-1")
				elseif index == 3 then
					--s_addTitle(SCENE_ENTRY_PLAYER,list[i+1],36)
					s_sysMail(list[i+1],"恭喜您获得血战到底第三名奖励：羽灵*10！请再接再厉！再升1名可获得羽灵*14！",0,27125,10,"1-1")
				elseif index <= 10 and index ~= 0 then
					s_sysMail(list[i+1],"恭喜您获得血战到底4-10名奖励羽灵*6！请再接再励！获得第三名可获得羽灵*10！",0,27125,6,"1-1")
				end
				if index > 10  and index <=50 then
					s_sysMail(list[i+1],"恭喜您获得血战到底前50名奖励羽灵*4！请再接再厉！获得前10名可获得羽灵*6！",0,27125,4,"1-1")
				end
				if index > 50 and index <= 100 then
					s_sysMail(list[i+1],"恭喜您获得血战到底前100名奖励羽灵*2！请再接再励！获得前50名可获得羽灵*4！",0,27125,2,"1-1")
				end
				--积分奖励
				if score >= 250 then
				...
				s_sysMail(list[i+1],"血战到底参与奖：羽灵*3！获得更高排名可获得更多羽灵。",0,27125,3,"1-1")
			else
				s_sysMail(list[i+1],"血战到底参与奖：羽灵*3！请再接再厉！进入高级场可获得更多羽灵！",0,27125,3,"1-1")
			end
		end
