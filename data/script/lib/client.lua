...
--一个通用的任务包裹界面调用
function ShowTaskPack(uid,caption,msg,buttonname,callback,needitem,itemlevel,itemquality)
	...
	local talkDialog =  'this:ShowNpcDialog(false)'
	local interfaceDialog= [[this:AddOneTableDialog("]] .. caption ..[[","]] .. msg ..[[","]] .. buttonname ..[[","]]..needitem..[[","]]..itemlevel..[[","]]..itemquality..[[")]]
	local message = talkDialog..interfaceDialog
	s_setMessage(uid,0,message,0)
end
--一个通用的任务包裹2格界面调用
