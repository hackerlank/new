--猎名师手札13
function OnUseItemEvent_47017(uid,thisid,targetid)
	if RoleTaskInfo30003:checkAccept(uid,47017,thisid) ~= VALUE_OK then
		return VALUE_FAIL
	end
	...
	if s_deleteItemByThisID(uid,thisid,1,"OnUseItemEvent_47017") ~= VALUE_OK then
		return VALUE_FAIL
	end
	RoleTaskInfo30003:AddTask(uid,quality,47017)
	times = times - 1
