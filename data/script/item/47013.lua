--猎名师手札9
function OnUseItemEvent_47013(uid,thisid,targetid)
	if RoleTaskInfo30003:checkAccept(uid,47013,thisid) ~= VALUE_OK then
		return VALUE_FAIL
	end
	...
	if s_deleteItemByThisID(uid,thisid,1,"OnUseItemEvent_47013") ~= VALUE_OK then
		return VALUE_FAIL
	end
	RoleTaskInfo30003:AddTask(uid,quality,47013)
	times = times - 1
