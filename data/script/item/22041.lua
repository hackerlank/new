--神秘手套图纸
function OnMakeItem_22041(uid,thisid,num, matid, matnum)
	...
	if s_deleteItemByThisID(uid,thisid,num,"生活制造") == VALUE_OK
		...
		AddRoleTaskOperate(uid,10551,"神秘护身符制作成功")
		return s_addItem(uid,targetid,0,num,1,attr,"合成")
	end
end
function OnProductItem_22041(uid,num, matid, matnum)
