--猎名师手札5
function OnUseItemEvent_47008(uid,thisid,targetid)
	if RoleTaskInfo30003:checkAccept(uid,47008,thisid) ~= VALUE_OK then
		return VALUE_FAIL
	end
	...
	if s_deleteItemByThisID(uid,thisid,1,"OnUseItemEvent_47008") ~= VALUE_OK then
		return VALUE_FAIL
	end
	RoleTaskInfo30003:AddTask(uid,quality,47008)
	times = times - 1
