--猎名师手札6
function OnUseItemEvent_47010(uid,thisid,targetid)
	if RoleTaskInfo30003:checkAccept(uid,47010,thisid) ~= VALUE_OK then
		return VALUE_FAIL
	end
	...
	if s_deleteItemByThisID(uid,thisid,1,"OnUseItemEvent_47010") ~= VALUE_OK then
		return VALUE_FAIL
	end
	RoleTaskInfo30003:AddTask(uid,quality,47010)
	times = times - 1
