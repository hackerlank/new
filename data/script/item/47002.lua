--猎名师手札2
function OnUseItemEvent_47002(uid,thisid,targetid)
	if RoleTaskInfo30003:checkAccept(uid,47002,thisid) ~= VALUE_OK then
		return VALUE_FAIL
	end
	...
	if s_deleteItemByThisID(uid,thisid,1,"OnUseItemEvent_47002") ~= VALUE_OK then
		return VALUE_FAIL
	end
	RoleTaskInfo30003:AddTask(uid,quality,47002)
	times = times - 1
