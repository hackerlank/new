--猎名师手札14
function OnUseItemEvent_47018(uid,thisid,targetid)
	if RoleTaskInfo30003:checkAccept(uid,47018,thisid) ~= VALUE_OK then
		return VALUE_FAIL
	end
	...
	if s_deleteItemByThisID(uid,thisid,1,"OnUseItemEvent_47018") ~= VALUE_OK then
		return VALUE_FAIL
	end
	RoleTaskInfo30003:AddTask(uid,quality,47018)
	times = times - 1
