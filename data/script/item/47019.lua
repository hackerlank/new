--猎名师手札15
function OnUseItemEvent_47019(uid,thisid,targetid)
	if RoleTaskInfo30003:checkAccept(uid,47019,thisid) ~= VALUE_OK then
		return VALUE_FAIL
	end
	...
	if s_deleteItemByThisID(uid,thisid,1,"OnUseItemEvent_47019") ~= VALUE_OK then
		return VALUE_FAIL
	end
	RoleTaskInfo30003:AddTask(uid,quality,47019)
	times = times - 1
