--小蓝
function OnUseItemEvent_23041(userid,thisid,targetid)
	...
	if s_deleteItemByThisID(userid,thisid,1,"OnUseItemEvent_23041") == VALUE_OK then
		s_addbuff(SCENE_ENTRY_PLAYER,userid,30002,16,16)
		return VALUE_OK
	end
	return VALUE_FAIL
end
