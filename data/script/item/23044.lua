--小兰
function OnUseItemEvent_23044(userid,thisid,targetid)
	...
	if s_deleteItemByThisID(userid,thisid,1,"OnUseItemEvent_23044") == VALUE_OK then
		s_addbuff(SCENE_ENTRY_PLAYER,userid,30002,40,16)
		return VALUE_OK
	end
	return VALUE_FAIL
end
