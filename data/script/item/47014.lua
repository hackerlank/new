--猎名师手札10
function OnUseItemEvent_47014(uid,thisid,targetid)
	if RoleTaskInfo30003:checkAccept(uid,47014,thisid) ~= VALUE_OK then
		return VALUE_FAIL
	end
	...
	if s_deleteItemByThisID(uid,thisid,1,"OnUseItemEvent_47014") ~= VALUE_OK then
		return VALUE_FAIL
	end
	RoleTaskInfo30003:AddTask(uid,quality,47014)
	times = times - 1
