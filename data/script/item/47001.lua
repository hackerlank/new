--猎名师手札1
function OnUseItemEvent_47001(uid,thisid,targetid)
	if RoleTaskInfo30003:checkAccept(uid,47001,thisid) ~= VALUE_OK then
		return VALUE_FAIL
	end
	...
	if s_deleteItemByThisID(uid,thisid,1,"OnUseItemEvent_47001") ~= VALUE_OK then
		return VALUE_FAIL
	end
	RoleTaskInfo30003:AddTask(uid,quality,47001)
	times = times - 1
