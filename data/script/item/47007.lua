--猎名师手札4
function OnUseItemEvent_47007(uid,thisid,targetid)
	if RoleTaskInfo30003:checkAccept(uid,47007,thisid) ~= VALUE_OK then
		return VALUE_FAIL
	end
	...
	if s_deleteItemByThisID(uid,thisid,1,"OnUseItemEvent_47007") ~= VALUE_OK then
		return VALUE_FAIL
	end
	RoleTaskInfo30003:AddTask(uid,quality,47007)
	times = times - 1
