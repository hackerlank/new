--猎名师手札3
function OnUseItemEvent_47003(uid,thisid,targetid)
	if RoleTaskInfo30003:checkAccept(uid,47003,thisid) ~= VALUE_OK then
		return VALUE_FAIL
	end
	...
	if s_deleteItemByThisID(uid,thisid,1,"OnUseItemEvent_47003") ~= VALUE_OK then
		return VALUE_FAIL
	end
	RoleTaskInfo30003:AddTask(uid,quality,47003)
	times = times - 1
