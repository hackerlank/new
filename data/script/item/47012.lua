--猎名师手札8
function OnUseItemEvent_47012(uid,thisid,targetid)
	if RoleTaskInfo30003:checkAccept(uid,47012,thisid) ~= VALUE_OK then
		return VALUE_FAIL
	end
	...
	if s_deleteItemByThisID(uid,thisid,1,"OnUseItemEvent_47012") ~= VALUE_OK then
		return VALUE_FAIL
	end
	RoleTaskInfo30003:AddTask(uid,quality,47012)
	times = times - 1
