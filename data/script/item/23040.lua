--小红
function OnUseItemEvent_23040(userid,thisid,targetid)
	...
	if s_deleteItemByThisID(userid,thisid,1,"OnUseItemEvent_23040") == VALUE_OK then
		s_addbuff(SCENE_ENTRY_PLAYER,userid,30001,150,16)
		return VALUE_OK
	end
	return VALUE_FAIL
end
