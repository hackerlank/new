--猎名师手札12
function OnUseItemEvent_47016(uid,thisid,targetid)
	if RoleTaskInfo30003:checkAccept(uid,47016,thisid) ~= VALUE_OK then
		return VALUE_FAIL
	end
	...
	if s_deleteItemByThisID(uid,thisid,1,"OnUseItemEvent_47016") ~= VALUE_OK then
		return VALUE_FAIL
	end
	RoleTaskInfo30003:AddTask(uid,quality,47016)
	times = times - 1
